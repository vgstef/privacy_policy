...
This privacy policy governs your use of the software application {{ page.app_name }} (“Application”) for mobile devices that was created by {{ site.owner_name }}. The Application is a social messenger which is used for free-of-cost communication across the world. 
